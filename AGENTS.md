...
**Data Categories**:
```javascript
persistentFields: ['firstName', 'lastName', 'licenseNumber', 'address', 'email', 'iban', 'bic', 'rib']
temporaryFields: ['matchDate', 'matchTime', 'matchLocation', 'homeTeam', 'awayTeam', 'category', 'position', 'matchIndemnity', 'travelIndemnity', 'madeIn', 'madeOn']
```
